...
ch.push(table(
  ...
  [
    ...
    ["初始属性", "体力 72 / 粮食 5 / 士气 62 / 信念 58 / 民心 48"],
    ["初始关系", "老班长 40、指导员 42、红小鬼 38、卫生员 36、老乡 28"],
    ["命名", "可跳过；默认「你」，对话中第二人称"],
...
ch.push(h3("交互"));
ch.push(
  bullet("过场：点按推进（点一下补全文 / 再点下一句）；可跳过。有配音的一拍**等这句念完再走**，没有音频也不受影响（红线：任何音频都不许阻塞流程）。"),
  bullet("电影化三处共用一套拍子：序章（题字 → 路线图 → 告别）、每幕幕间（回望：地图点亮已走过的每一段 + 上一幕总评两句 → 本幕空镜 → 本幕题字）、终章升华（会宁空镜 → 诗八句逐字 → 钤印落款）。全片不出现视频，只有静帧 + 字幕 + 音频。"),
...
ch.push(p("开场是一段可跳过的序章，由与其他两处（幕间过渡、终章升华）**共用的「拍子」播放器**演出："
  + "题字 / 路线图 / 空镜 / 诗 / 钤印五种镜头、一套节奏；自动播 + 点按推进 + 可跳过，"
  + "系统开了「减少动效」时位移类关闭、字幕整段直显（音频照播）。"));
ch.push(table(
  ["步骤", "内容", "交互", "AI"],
  [
    ["S1", "黑场题字：于都河 · 一九三四年十月（八万六千人，八个渡口）", "自动 + 点按", "无"],
    ["S1b", "路线图：六站行程逐节点亮（于都河 → 会宁）", "自动 + 点按", "无"],
    ["S2", "人设三选一（农家/学徒/学生）+ 开场问答", "点选", "无（本地改属性）"],
    ["S2b", "告别空镜两拍：母亲一句、旁白一句（预录台词）", "自动 + 点按", "无"],
...
ch.push(table(
  ["类别", "角色"],
  [
    ["核心同伴", "老班长、指导员、红小鬼、卫生员、老乡（五人，已具备）"],
