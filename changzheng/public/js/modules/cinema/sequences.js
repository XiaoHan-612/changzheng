 ...
 *   底图由 `ctx.mapImg` 给（流程层用 `sceneImage()` 探测"有没有暗调新版"），缺省用现成的 `map_route.jpg`。
   ...
   */
  'ending-poem': ({ photoImg = '/assets/scenes/huining_pano.jpg', paperImg = '', gallery = [] } = {}) => [
    {
      kind: 'photo',
      img: photoImg,
    ...
    // 诗拍：gallery 为各幕 pano，朗读期间在过场底片上轮播
    { kind: 'poem', img: paperImg || undefined, gallery },
    { kind: 'seal' },
  ],
