/**
 * 金色的鱼钩（第一人称钓鱼：蓄力抛竿 → 漂相三档 → 张力甜区搏鱼）（`goldenhook`）—— 同事重做的玩法，薄适配进我们的插件契约。
 *
 * 玩法本体在 [`src/minigames-fishing.js`](./src/minigames-fishing.js)：同事**单独开发**的那条线（他们的写法）。
 * 本文件只做三件事，玩法逻辑一个字没动：
 ...
 * 落点：第四幕 · 草地 · 水泡子边。
 */
import * as mod from './src/minigames-fishing.js';
